    ...
    <div class="container">
        <div class="section-padding section-white">
            ...
            <span class="callback-description">
                При необходимости возможна рассрочка на основе программ Kaspi Red / Tinkoff.</br>
                По факту оплаты Вам будет предоставлен кассовый чек в электронном виде.
            </span>
            <h1 class="callback-heading">давайте будем на связи!</h1>

            <div class="intouch">
                <div class="intouch-col">
                    <a href="https://vk.com/mbbm.club" class="intouch-social" target="_blank">
                    ...
                    <a href="https://t.me/+W38CD53dyPExZmJi" class="intouch-social" target="_blank">
                        ...
                        Следите за интересной информацией в открытой группе Телеграм
                    </a>
                </div><!-- /.intouch-col -->
                <div class="intouch-col">
        ...
        </div><!-- /.section-padding section-white -->
    </div><!-- /.container -->
</section>